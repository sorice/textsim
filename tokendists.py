...
class Stringdists:
    ...
    def len_texto(self,direccion_doc,idioma):
    ...
    def matching_coefficient(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def jaccard(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def dice_coefficient(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def overlap(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def euclidean(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def manhattan(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def num(self,s1,s2,idioma):#metodo auxiliar que calcula la parte del numerador del metodo coseno
        s1=lower(s1)
        s2=lower(s2)
        ...
        return suma
    def norma(self,s,idioma):#metodo para normalizar
        s=lower(s)
        ...
        return resultado
    def cos(self,s1=None,s2=None,doc1=None,doc2=None,idioma='english'):
        """
    ...
    def binary_distance(self,s1=None, s2=None, doc1=None,doc2=None,idioma='english'):
    ...
    def masi_distance(self,s1=None, s2=None, doc1=None,doc2=None,idioma='english'):
    ...
    def interval_distance(self,label1,label2):
    ...
    def presence(self,label):
        """Higher-order function to test presence of a given label
        """

        return lambda x, y: 1.0 * ((label in x) == (label in y))

    def jaccard_ulacia(self,v1=None,v2=None,doc1=None,doc2=None,idioma='english'):
        ...
        for i in d1:   
            for j in d2:
                try: 
                    ...
                    c= Chardists()
                    if len(i)<len(j):
                        tmp=float(c.damerau_levenshtein_distance(i, j, doc1, doc2))
                    else:
                        tmp=float(c.damerau_levenshtein_distance(i, j, doc1, doc2))
                    if tmp<0.3:
                        contador+=1 
    ...
    def fractional_presence(self,label):
        return lambda x, y:\
